...
#     def __init__(self, DataFed_path, isRecord=True):
...
#                 if idx == 0:
#                     DataFed_parent_collection_id = (
#                         f"c/p_{DataFed_path_list[0].lower()}_root"
#                     )
#                     ls_resp = self.df_api.collectionItemsList(
#                         DataFed_parent_collection_id
#                     )
...
#                     DataFed_parent_collection_id = (
#                         ls_resp[0].item[trials_already_in_DataFed.index(elem)].id
#                     )

#                     try:
#                         ls_resp_2 = self.df_api.collectionItemsList(
#                             DataFed_parent_collection_id
#                         )
...
#                         ls_resp_2 = self.df_api.collectionItemsList(
#                             self.df_api.collectionGetParents(
#                                 DataFed_parent_collection_id
#                             )[0]
#                             .path[0]
#                             .item[0]
...
#                         rec_resp = self.df_api.dataCreate(
#                             elem,
#                             metadata=json.dumps({"testing": 123}),
#                             parent_id=DataFed_parent_collection_id,
#                         )  # ADD DATA/METADATA STUFF???????
...
#                             elem, parent_id=DataFed_parent_collection_id
#                         )
#                         ls_resp_2 = self.df_api.collectionItemsList(
#                             coll_resp[0].coll[0].id
#                         )
...
# def upload_to_datafed(
#     folder_model,
#     log_file_path,
#     globus_endpoint_set,
#     DataFed_project_name,
#     DataFed_record_title,
#     DataFed_record_metadata,
#     DataFed_record_filename,
# ):
#     """
...
#                 ls_resp[0]
#                 .item[np.where(folder_model in trials_already_in_DataFed)[0].item()]
#                 .id
#             )
...
#                 folder_model, parent_id=DataFed_project_name
#             )
...
#             new_collections_made += 1
#             coll_resp = df_api.collectionCreate(
#                 f"{folder_model}_{new_collections_made}", parent_id=DataFed_project_name
#             )
#             Datafed_collection_id = coll_resp[0].coll[0].id
...
#             DataFed_record_title,
#             metadata=json.dumps(DataFed_record_metadata),
#             parent_id=Datafed_collection_id,
#         )
